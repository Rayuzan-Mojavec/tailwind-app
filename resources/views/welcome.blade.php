...
<div
    class="transition-all h-auto items-center max-w-7xl mx-auto mb-28 bg-[#EB2854] hover:bg-sky-500 p-5 flex justify-center border-8 border-black rounded-2xl group">
    <span
        class="text-4xl text-white py-3 selection:bg-blue-800 selection:text-white invisible group-hover:visible group-hover:text-black group-hover:blur-none font-serif first-letter:text-8xl first-letter:font-bold">
